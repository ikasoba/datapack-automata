...
scoreboard players remove @s __automata_tmp 120

execute unless data entity @s Pose.LeftArm run data modify entity @s Pose.LeftArm set value [0f, 0f, 0.01f]
data modify entity @s Pose.LeftArm[0] set value -45f
data modify entity @s Pose.LeftArm[1] set value 0f
execute store result entity @s Pose.LeftArm[2] float -0.1666 run scoreboard players get @s __automata_tmp

execute unless data entity @s Pose.RightArm run data modify entity @s Pose.RightArm set value [0f, 0f, 0.01f]
data modify entity @s Pose.RightArm[0] set value -45f
data modify entity @s Pose.RightArm[1] set value 0f
execute store result entity @s Pose.RightArm[2] float 0.1666 run scoreboard players get @s __automata_tmp
